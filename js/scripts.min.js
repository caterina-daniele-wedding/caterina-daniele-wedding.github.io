...
$(document).ready(function() {
	...
	$(".player").YTPlayer(), $("#btn-show-map").click(function() {
		...
		window.open("https://maps.app.goo.gl/2b2jnwmtQwKpwEnB7", '_blank').focus();
	}), 
	...
	var r = createCalendar({
		...
		data: {
			...
			address: "Via Gagliardi 1, Mestre, Venice",
			description: "We can't wait to see you."
		}
	});
	var rIta = createCalendar({
        options: {
            class: '',
	...
	$("#add-to-cal").html(r),
	$("#add-to-cal-ita").html(rIta), 
	$("#rsvp-form").on("submit", function(e) {
		e.preventDefault();
		var t = $(this).serialize();
		$("#alert-wrapper").html(alert_markup("info", "<strong>Just a sec!</strong> We are saving your details.")), "bb0efea553d080b06053dc948148a8fe" !== MD5($("#invite_code").val()) ? $("#alert-wrapper").html(alert_markup("danger", "<strong>Sorry!</strong> Your invite code is incorrect.")) : $.post("https://script.google.com/macros/s/AKfycbxhKClIcfNLlhJF2wymeJc4Gh4CygOoD4bx88w59ALeLXoUXNfY7hR1UKwOCkJ7fWLD/exec", t).done(function(e) {
